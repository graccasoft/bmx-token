...
contract Stakeable {
	...
	* @notice Staked event is triggered whenever a user stakes tokens, address is indexed to make it filterable
     ...
     */
	uint256 internal rewardPerHour = 4;
    ...
    * StakeID
    */
	function _stake(uint256 _amount,address account) internal{
		...
		stakeholders[index].address_stakes.push(Stake(account, _amount, timestamp,0));
    ...
    */
	function _withdrawStake(uint256 amount, uint256 index,address account) internal returns(uint256){
